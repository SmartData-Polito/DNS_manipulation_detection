...
def main ():
    ...
    for domain in considered_domains:
        ...
        for resolver in data_per_domain[domain]:
            ...
            max_ttl_rounded = math.ceil(max_ttl/ttl_granularity)*ttl_granularity 
...
def statistical_anomalies(s):
  s_sum = sum(s)
  s_sorted_norm = [ e/s_sum for e in sorted (s, reverse=True) ]
